...
#include "EnemyProjectile_StampipedeLsr.generated.h"

/**
 * 
 */
UCLASS()
class NPROJECT2_GH_API AEnemyProjectile_StampipedeLsr : public ABaseEnemyProjectile
{
	GENERATED_BODY()

public:
	//Class defaults
	AEnemyProjectile_StampipedeLsr();
